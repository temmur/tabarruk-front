<template>
  ...
  >
    <span
        :class="[
        'absolute inset-0 rounded-lg p-[1.5px] opacity-0 transition-opacity duration-300 group-hover:opacity-100',
        gradientClasses
      ]"
    ></span>
    ...
    <span
        :class="[
        'relative z-10 flex items-center space-x-2 px-4 py-2 rounded-lg',
        innerBgClasses
      ]"
    >
