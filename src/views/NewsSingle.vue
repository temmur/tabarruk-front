<template>
  <div class="bg-[#070b1a] text-white min-h-screen font-sans pt-34">
    ...
    <main class="max-w-3xl mx-auto px-4 text-left">
      ...
      <h1 class=" font-semibold leading-snug  text-4xl">2025-yil 18-fevral kuni O‘zbekistondagi <br> Amirsoy tog‘-chang‘i kurortida chang‘i <br> bo‘yicha Turkiy davlatlar kubogi bo‘lib <br> o‘tadi  </h1>
      ...
      <div class="flex items-center gap-4 text-gray-400 text-base mb-6">
        ...
        <span class="flex items-center mt-6 text-gray-400 text-base">
          <i class="fa-regular fa-eye fa-gray-400"></i> 40
        </span>
      </div>
