...
const slides = ref([
  {
    image: 'https://tabarrukziyorat.uz/media/destination_images/samarkand-uzbekistan-kupol-mechet-ploshchad.jpg',
  ...
  {
    image: 'https://tabarrukziyorat.uz/media/destination_images/3_zL7Uu07.jpg',
  ...
  {
    image: 'https://tabarrukziyorat.uz/media/destination_images/2T0A4816.jpg',
...
const formattedCurrent = computed(() => {
  const num = currentIndex.value + 1
