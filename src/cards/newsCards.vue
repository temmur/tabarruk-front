  ...
  <section class="w-full px-6 py-12 bg-gray-400 hover:bg-gray-600 container">
    ...
    <div class="flex flex-cols-1  md:flex-cols-3 justify-between gap-6 max-w-5xl mx-auto cursor-pointer ">
      <div class="md:col-span-1">
        <div class="bg-gray-800 rounded-xl border border-gray-500/40 backdrop-blur-sm p-4 flex gap-4 justify-center items-center text-white w-[620px] h-[320px]
...
">
      ...
      <div class="md:col-span-2 flex flex-col hover:bg-gray-500 cursor-pointer gap-3">
        <div
